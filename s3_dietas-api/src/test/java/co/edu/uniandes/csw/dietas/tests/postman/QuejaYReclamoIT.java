 ...
 */
package co.edu.uniandes.csw.dietas.tests.postman;
import co.edu.uniandes.csw.dietas.mappers.BusinessLogicExceptionMapper;
import co.edu.uniandes.csw.dietas.dtos.CascaraDTO;
import co.edu.uniandes.csw.dietas.resources.RestConfig;
...
public class QuejaYReclamoIT {
    private static final String COLLECTION = "QuejasYReclamos.postman_collection";

    @Deployment(testable = true)
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s3_dietas-api.war")//War del modulo api
